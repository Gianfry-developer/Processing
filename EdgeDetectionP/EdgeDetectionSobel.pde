...
void draw()
{
  ...
  for(int j=0;j<img.width-2;j++)
  {
    ...
    int Gijx=(img.pixels[i7]+(2*img.pixels[i8])+img.pixels[i9])-(img.pixels[i1]+(2*img.pixels[i2])+img.pixels[i3]); 
    int Gijy=(img.pixels[i3]+(2*img.pixels[i6])+img.pixels[i9])-(img.pixels[i1]+(2*img.pixels[i4])+img.pixels[i7]);
